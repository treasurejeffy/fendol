...
import { Spinner, Alert } from 'react-bootstrap'; // Import Spinner and Alert from Bootstrap
...
export default function ViewAddFishHistory() {
  ...
  useEffect(() => {
    const fetchFishStages = async () => {
      try {
        const response = await axios.get('https://your-api-endpoint.com/fish-stages'); // Replace with your API endpoint
        setFishStages(response.data); // Assuming the response is an array of fish stages
      } catch (error) {
  ...
  useEffect(() => {
    const fetchTableData = async () => {
      try {
        const response = await axios.get('https://your-api-endpoint.com/fish-history'); // Replace with your API endpoint
